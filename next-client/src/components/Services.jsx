                        ...
                        >
                            ...
                            >
                                ...
                                <div className="relative z-10 flex flex-col h-full">
                                    <div className="mb-8 inline-flex items-center justify-center p-5 rounded-2xl bg-blue-50 border border-blue-100 text-primary group-hover:bg-primary group-hover:text-white transition-all duration-300 shadow-sm w-fit group-hover:scale-110 group-hover:rotate-3">
                                        {service.icon}
                                    </div>
