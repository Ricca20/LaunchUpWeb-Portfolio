...
const Projects = () => {
    ...
    return (
        <section id="portfolio" className="py-32 relative bg-white overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    <div className="inline-flex items-center space-x-2 bg-black/5 border border-black/5 rounded-full px-4 py-1.5 mb-6 backdrop-blur-sm">
                        ...
                        <span className="text-sm font-medium text-gray-700">Selected Works</span>
                    </div>
                    ...
                    {projects.map((project, index) => (
                        ...
                        >
                            <motion.div
                                ...
                                className="group h-full bg-black/5 backdrop-blur-xl border border-black/5 rounded-3xl overflow-hidden flex flex-col relative"
                            ...
                            >
                                ...
                                <div className="p-8 flex-grow flex flex-col h-full" style={{ transform: 'translateZ(30px)' }}>
                                    ...
                                    <div className="flex items-start justify-between mb-4">
                                        <div className={`text-[10px] font-bold px-3 py-1 rounded-full bg-gradient-to-r ${project.color} bg-opacity-20 text-gray-900 uppercase tracking-widest border border-black/5 shadow-lg shadow-black/20`}>
                                            {project.category}
                                        </div>
                                        {/* Globe Icon removed as mostly redundant or moved to bottom */}
                                    </div>

                                    <h3 className="text-2xl md:text-3xl font-bold mb-3 text-gray-900 group-hover:text-primary transition-colors min-h-[4rem] flex items-center leading-tight">
                                        {project.title}
                                    </h3>

                                    <p className="text-gray-600 mb-6 leading-relaxed line-clamp-3 text-sm md:text-base h-[4.5rem]">
                                        {project.description}
                                    </p>
                                    ...
                                    <div className="flex flex-wrap gap-2 mb-8 min-h-[2rem] content-start">
                                        {project.technologies.map((tech, i) => (
                                            <span key={i} className="text-[10px] font-semibold text-gray-700 bg-black/5 px-2.5 py-1 rounded-md border border-black/5 flex items-center hover:bg-black/5 transition-colors cursor-default">
                                                {tech}
                                            </span>
                                        ))}
                                    </div>
                                    ...
                                    <div className="pt-6 border-t border-white/5 mt-auto bg-gradient-to-t from-dark/20 to-transparent -mx-8 -mb-8 px-8 pb-8">
                                        <div className="flex items-end justify-between mt-4">
                                            <div className="flex flex-col">
                                                ...
                                                <span className="text-sm text-gray-800 font-medium max-w-[12rem] leading-snug">{project.results}</span>
                                            </div>
                                            <a
                                                href={project.liveLink}
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="group/btn relative overflow-hidden w-12 h-12 rounded-full bg-black/5 flex items-center justify-center text-gray-900 hover:bg-primary transition-all duration-300 border border-black/5 shadow-lg hover:shadow-primary/25"
                                            >
                ...
                >
                    <a href="#contact" className="group relative inline-flex items-center justify-center px-8 py-4 font-bold text-gray-900 transition-all duration-200 bg-primary font-lg rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary hover:bg-secondary">
