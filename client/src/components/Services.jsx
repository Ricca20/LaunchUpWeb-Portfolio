            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    {services.map((service, index) => (
                        ...
                        >
                            <motion.div
                                ...
                                className="h-full bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-3xl group hover:border-primary/30 transition-all duration-500 relative overflow-hidden"
                            ...
                            >
                                ...
                                <div className="relative z-10" style={{ transform: "translateZ(20px)" }}>
                                    <div className="mb-6 inline-flex items-center justify-center p-4 rounded-2xl bg-white/5 border border-white/10 text-white group-hover:scale-110 group-hover:bg-white/10 transition-all duration-300 shadow-lg">
                                        {service.icon}
                                    </div>
                                    ...
                                    <div className="text-sm text-gray-500 border-t border-white/5 pt-4 group-hover:border-white/10 transition-colors">
                                        <span className="font-semibold text-primary">Perfect for:</span> <span className="text-gray-300">{service.perfectFor}</span>
                                    </div>
                                </div>
                            </motion.div>
                        </Tilt>
                ...
                <div className="text-center">
                    <motion.a
                        ...
                        whileTap={{ scale: 0.95 }}
                        href="#contact"
                        className="group relative inline-flex items-center bg-transparent border border-white/20 hover:border-primary/50 text-white font-bold py-4 px-10 rounded-full transition-all duration-300 backdrop-blur-sm overflow-hidden"
                    >
