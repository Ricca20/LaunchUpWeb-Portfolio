            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <div className="mt-8">
                            <a href="#contact" className="inline-flex items-center text-primary font-bold hover:text-white transition-colors">
                    ...
                    >
                        ...
                        <div className="bg-surface border border-gray-800 p-8 rounded-2xl text-center hover:border-secondary/50 transition-colors">
                            ...
                            <p className="text-gray-400 font-medium">International Clients</p>
