    ...
    return (
        <section id="process" className="py-20 bg-dark relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Our Simple 4-Step Process</h2>
                    ...
                    {steps.map((step, index) => (
                        ...
                        >
                            ...
                            <div className="text-center px-4">
                                <div className="inline-block bg-gray-800 rounded-full px-3 py-1 text-xs font-bold text-gray-400 mb-3">
                                    STEP {index + 1}
                                </div>
