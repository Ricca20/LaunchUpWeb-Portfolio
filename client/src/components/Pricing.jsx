...
const Pricing = () => {
    ...
    return (
        <section id="pricing" className="py-20 bg-dark relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {plans.map((plan, index) => (
                        ...
                        >
                            ...
                            <p className="text-gray-400 text-sm mb-6 pb-6 border-b border-gray-700">{plan.subtitle}</p>
                            ...
                            <div className="mt-auto">
                                <a href="#contact" className={`block w-full text-center py-4 rounded-xl font-bold transition-all duration-300 ${plan.popular ? 'bg-primary hover:bg-blue-600 text-white' : 'bg-gray-800 hover:bg-gray-700 text-white'}`}>
                                    {plan.cta}
                                </a>
                            </div>
                        </motion.div>
