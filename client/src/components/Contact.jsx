...
const Contact = () => {
    ...
    return (
        <section id="contact" className="py-32 bg-dark relative overflow-hidden perspective-1000">
            {/* 3D Floating Objects */}
            <div className="absolute inset-0 pointer-events-none">
                ...
                <motion.div
                    ...
                    className="absolute top-[20%] left-[10%] w-20 h-20 bg-gradient-to-br from-white/10 to-transparent border border-white/10 backdrop-blur-md rounded-2xl transform rotate-45"
                />
                <motion.div
                    animate={{ y: [0, 30, 0], rotateZ: [0, -10, 0] }}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    <span className="inline-block py-1 px-3 rounded-full bg-surface border border-white/10 text-sm font-medium text-primary mb-4">Let's Work Together</span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                    ...
                    >
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <Tilt tiltMaxAngleX={10} tiltMaxAngleY={10} className="h-full">
                                <div className="bg-surface/50 border border-white/5 p-8 rounded-3xl h-full hover:bg-surface hover:border-primary/30 transition-all duration-300 group shadow-lg">
                                    ...
                                    <p className="text-gray-400 mb-4">+94 77 832 0044</p>
                                    <a href="#" className="text-primary font-bold hover:text-white transition-colors flex items-center group-hover:translate-x-2 duration-300">
                            ...
                            <Tilt tiltMaxAngleX={10} tiltMaxAngleY={10} className="h-full">
                                <div className="bg-surface/50 border border-white/5 p-8 rounded-3xl h-full hover:bg-surface hover:border-secondary/30 transition-all duration-300 group shadow-lg">
                                    ...
                                    <p className="text-gray-400 mb-4">hello@launchupweb.com</p>
                                    <a href="mailto:hello@launchupweb.com" className="text-secondary font-bold hover:text-white transition-colors flex items-center group-hover:translate-x-2 duration-300">
                        ...
                        <div className="bg-gradient-to-r from-surface to-dark border border-white/5 p-8 rounded-3xl relative overflow-hidden group">
                            <div className="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-full blur-2xl -mr-10 -mt-10 group-hover:bg-primary/10 transition-colors" />
                            <div className="relative z-10 flex items-start">
                                <div className="bg-gray-800 p-3 rounded-xl text-white mr-6 mt-1 shadow-lg">
                                    <MapPin size={24} />
                                </div>
                                <div>
                                    <h3 className="text-white font-bold text-xl mb-2">Global Reach, Local Roots</h3>
                            ...
                            <div className="flex gap-4">
                                {[Facebook, Linkedin, Instagram].map((Icon, idx) => (
                                    <motion.a
                                        ...
                                        href="#"
                                        className="bg-surface border border-white/10 p-4 rounded-xl text-gray-400 transition-all duration-300"
                                    >
                                        <Icon size={24} />
                                    </motion.a>
                                ))}
                    ...
                    >
                        <Tilt
                            ...
                            tiltMaxAngleY={5}
                            perspective={1500}
                            className="bg-dark/50 backdrop-blur-3xl border border-white/10 p-1 rounded-[40px] shadow-2xl relative"
                        >
                            <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent rounded-[40px] pointer-events-none" />

                            <div className="bg-dark/80 rounded-[36px] p-8 md:p-10 relative z-10">
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="group">
                                            ...
                                            <input
                                                ...
                                                required
                                                className="w-full bg-surface border border-gray-700 rounded-xl px-4 py-4 text-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all placeholder-gray-600 font-medium"
                                    ...
                                    <div className="group">
                                        ...
                                        <div className="relative">
                                            <select
                                                ...
                                                onChange={handleChange}
                                                className="w-full bg-surface border border-gray-700 rounded-xl px-4 py-4 text-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all appearance-none font-medium cursor-pointer"
                                            >
                                    ...
                                    <div className="group">
                                        ...
                                        <textarea
                                            ...
                                            required
                                            rows="4"
                                            className="w-full bg-surface border border-gray-700 rounded-xl px-4 py-4 text-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all placeholder-gray-600 font-medium resize-none"
                                    ...
                                    <motion.button
                                        ...
                                        className={`w-full flex items-center justify-center py-5 px-6 rounded-xl font-bold text-white text-lg transition-all duration-300 shadow-xl ${status === 'success' ? 'bg-green-600 shadow-green-900/20' : 'bg-gradient-to-r from-primary to-secondary shadow-primary/25 hover:shadow-primary/40'
                                            }`}
                                    >
                                        {status === 'sending' ? (
                                            'Sending...'
